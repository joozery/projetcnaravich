...
function TestSilkReactbits() {
  return (
    <div className="min-h-screen bg-gray-900 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        
        <h1 className="text-3xl font-bold text-center text-white mb-8">
          ทดสอบ Silk Component จาก Reactbits.dev
        </h1>
        ...
        {/* Silk สีน้ำเงิน */}
        <div>
          <h2 className="text-xl font-bold mb-4 text-white">Silk สีน้ำเงิน</h2>
          <div className="h-64 rounded-lg overflow-hidden shadow-lg border-2 border-gray-600 bg-white">
            <Silk
              speed={3}
              scale={1.2}
        ...
        {/* Silk สีเขียว */}
        <div>
          <h2 className="text-xl font-bold mb-4 text-white">Silk สีเขียว</h2>
          <div className="h-64 rounded-lg overflow-hidden shadow-lg border-2 border-gray-600 bg-white">
            <Silk
              speed={8}
              scale={0.8}
        ...
        {/* Silk สีม่วง */}
        <div>
          <h2 className="text-xl font-bold mb-4 text-white">Silk สีม่วง</h2>
          <div className="h-64 rounded-lg overflow-hidden shadow-lg border-2 border-gray-600 bg-white">
            <Silk
              speed={2}
              scale={1.5}
        ...
        {/* แบนเนอร์ตัวอย่าง */}
        <div>
          <h2 className="text-xl font-bold mb-4 text-white">แบนเนอร์ตัวอย่าง</h2>
...
export default TestSilkReactbits;
